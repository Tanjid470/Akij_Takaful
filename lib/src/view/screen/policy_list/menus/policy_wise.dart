...
class PolicyWise extends StatefulWidget {
  const PolicyWise({Key? key}) : super(key: key);

  @override
  State<PolicyWise> createState() => _PolicyWiseState();
}

final policyController = Get.find<PolicyController>();

class _PolicyWiseState extends State<PolicyWise> {
  @override
  void initState() {
    policyController.callFunctionInitially("PolicyWise");
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: GestureDetector(
        ...
        child: Scaffold(
          appBar: const BaseAppBar(title: 'Policy Wise List'),
          ...
          body: SingleChildScrollView(
            child: Column(children: [
              CustomTextWithSearch(
                ...
                function: () {
                  policyController.getpolicyListDetailsPolicyWise(
                      policyController.policyEditingController.text);
                },
                hinText: 'Enter Policy no',
              ),
              Obx(
