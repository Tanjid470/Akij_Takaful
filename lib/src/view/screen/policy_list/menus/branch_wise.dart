...
class BranchWise extends StatefulWidget {
  const BranchWise({Key? key}) : super(key: key);

  @override
  State<BranchWise> createState() => _BranchWiseState();
}

final policyController = Get.find<PolicyController>();

class _BranchWiseState extends State<BranchWise> {
  @override
  void initState() {
    policyController.callFunctionInitially("BranchWise");
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: GestureDetector(
        ...
        child: Scaffold(
          appBar: const BaseAppBar(title: 'Branch Wise List'),
          ...
          body: SingleChildScrollView(
            child: Column(children: [
                        ...
                        child: DropdownButtonHideUnderline(
                          child: ButtonTheme(
                            ...
                            child: DropdownButton<Office>(
                              itemHeight: 60.0,
                              isExpanded: true,
                              value: policyController.selectedOffice.value,
                              iconSize: 30,
                              icon: (null),
                              hint: const Text(
                                'Select Branch Code',
                              ...
                              onChanged: (value) {
                                if (value != null) {
                                  policyController.onOfficeSelected(value);
                                }
                              },
                              items: policyController.offices
                                  .map<DropdownMenuItem<Office>>((office) =>
                                      DropdownMenuItem<Office>(
                                        value: office,
                                        child:
                                            Text(office.officeName.toString()),
                                      ))
                                  .toList(),
                            ),
                          ),
              ...
              LargeButton(
                  btnText: "Search",
                  onPressed: () =>
                      policyController.getpolicyListDetailsBranchWise(
                          policyController.selectedOffice.value!.officeCode)),
              Obx(
