...
class _MonthWiseState extends State<MonthWise> {
  @override
  void initState() {
    policyController.callFunctionInitially("MonthWise");
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: GestureDetector(
        ...
        child: Scaffold(
          appBar: const BaseAppBar(title: 'Month Wise List'),
            ...
            child: Column(children: [
              Padding(
                ...
                child: CustomDatePicker(
                  hintText: 'Business Month',
                  controller: policyController.monthEditingController,
                  icon: Icons.calendar_month_rounded,
                  color: AppColors.white,
                  readOnly: true,
                  controllerText: policyController.selectedBusinessMonth.value,
                  onTap: () async {
                    final DateTime? picked =
                        await customDatePickerColor(context);
                    policyController.updateSelectedMonth(
                        picked, policyController.selectedBusinessMonth);
                  },
                ),
              ),
              const SizedBox(
              ...
              LargeButton(
                btnText: "Search",
                onPressed: () => policyController.getpolicyListDetailsMonthWise(
                    policyController.selectedBusinessMonth.value,
